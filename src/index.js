...
class App extends Component{
  ...
  render({checklists,done,selected,team,project_name,url},state,ctx){
    return (
      <div>
        <Header checklists={checklists} selected={selected} done={done} team={team} project_name={project_name} url={url} />
